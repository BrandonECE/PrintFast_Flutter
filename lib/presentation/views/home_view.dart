...
class MyHomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void onTapBottomNav(int index, HomeBloc homeBloc) {
      ...
      homeBloc.add(HomeChangeIndexBottomNavigationBarEvent(currentInde: index));
    }
  ...
  BlocBuilder _myBottomNavigationBar(BuildContext context, void Function(int index, HomeBloc homeBloc) onTapBottomNav,) {
