...
class MyActiveOrderView extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                _infoRow(context,
                  ...
                  text: homeState.selectedOrder.place,
                ),
                const SizedBox(height: 4),
                _infoRow(context,
                  icon: Icons.picture_as_pdf_rounded,
                  text: homeState.selectedOrder.pdfName,
                ),
              ],
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _dateItem(context, Icons.calendar_month_rounded, formatDateToYMD(homeState.selectedOrder.initDate)),
              const SizedBox(width: 7),
              _dateItem(context, Icons.access_time_rounded, formatTimeToAmPm(homeState.selectedOrder.initDate, uppercaseSuffix: false)),
            ],
          ),
          const SizedBox(height: 12),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              _dateItemPrimary(context, Icons.calendar_month_rounded, formatDateToYMD(homeState.selectedOrder.estimatedDeliveryTime!)),
              const SizedBox(width: 7),
              _dateItemPrimary(context, Icons.access_time_rounded, formatTimeToAmPm(homeState.selectedOrder.estimatedDeliveryTime!, uppercaseSuffix: false)),
            ],
          ),
          const SizedBox(height: 12),
              ...
              Expanded(
                child: Wrap(
                  ...
                  children: [
                    ...
                    _detailChip(context, label: homeState.selectedOrder.isColor ? 'Color' : 'B/N'),
                    _detailChip(context, label: '${homeState.selectedOrder.pages} pág'),
                  ],
                ),
              ),
  ...
  Widget _previewCard(
    ...
    final colorScheme = Theme.of(context).colorScheme;
    final bool showCodeButton = homeState.selectedOrder.hasItBeenCanceledByUser;
