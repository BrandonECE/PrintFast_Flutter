...
class MyShoppingPdfView extends StatefulWidget {
  const MyShoppingPdfView({super.key});

  @override
  State<MyShoppingPdfView> createState() => _MyShoppingPdfViewState();
}

class _MyShoppingPdfViewState extends State<MyShoppingPdfView> {
