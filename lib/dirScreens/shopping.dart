...
class _containerMyShoppingState extends State<containerMyShopping> {
  ...
  Widget build(BuildContext context) {
    ...
    void updateFormat(bool value) {
      isFormatCarta = value;
      sumaTotalImpresion = countPagesDocumentCopy * (isFormatCarta ? 2 : 3);
      setState(() {});
    }
      ...
      try {
        ...
        if (result != null) {
          if (result!.files.first.extension == "PDF" ||
            ...
            sumaTotalImpresion += pdfdoc.pageCount * (isFormatCarta ? 2 : 3);
            countPagesDocumentCopy = pdfdoc.pageCount;
            print(sumaTotalImpresion);
            sectionCopyWidgetsIndex = 1;
            print("PATH: ${result!.paths[0]}");
            WidgetsBinding.instance.addPostFrameCallback(
              (timeStamp) {
                final sharedChangeNotifier =
                    Provider.of<SharedChangeNotifier>(context, listen: false);
                // final sharedChangeNotifier = Provider.of<SharedChangeNotifier>(context, listen: false);;
                sharedChangeNotifier.updatePathPrint(result!.paths[0]!);
              },
            );
            getTotal();
          } else {
    ...
    return Column(
      children: <Widget>[
        ...
        titlesContainer("Formato"),
        myWidgetTypeFormat(
            isColor: isColor,
            isFormatCarta: isFormatCarta,
            updateFormat: updateFormat),
        titlesContainer("Previsual"),
        Expanded(
          child: Container(
              ...
              child: result == null
                  ...
                  : PdfViewer.openFile(result!.paths[0]!)),
        ),
...
class myWidgetTypeFormat extends StatelessWidget {
  const myWidgetTypeFormat(
      {super.key,
  ...
  final void Function(bool) updateFormat;
  final bool isColor;
            ...
            Checkbox(
              ...
              onChanged: (value) {
                if (!isFormatCarta) {
                  final sharedChangeNotifier =
                      Provider.of<SharedChangeNotifier>(context, listen: false);;
                  sharedChangeNotifier.updateIsFormatoCardToPrint(true);
                  updateFormat(true);
                }
              },
            ),
            ...
            Checkbox(
              ...
              onChanged: (value) {
                if (isFormatCarta) {
                  final sharedChangeNotifier =
                      Provider.of<SharedChangeNotifier>(context, listen: false);;
                  sharedChangeNotifier.updateIsFormatoCardToPrint(false);
                  updateFormat(false);
                }
              },
            ),
...
class sectionContainerMyShoppingCopy extends StatelessWidget {
  sectionContainerMyShoppingCopy(
      {super.key,
      required this.callGetFile,
      required this.isColor,
      required this.updateColor});
  VoidCallback callGetFile;
  final bool isColor;
  final void Function(bool) updateColor;
                      ...
                      children: [
                        Checkbox(
                          ...
                          onChanged: (value) {
                            final sharedChangeNotifier =
                                Provider.of<SharedChangeNotifier>(context, listen: false);;
                            sharedChangeNotifier.updateIsColorToPrint(value!);
                            updateColor(value);
                          },
                        ),
                        Text(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            Colors.redAccent, // Hace el botón transparente
                        elevation: 0, // Quita la sombra del botón
...
class sectionContainerMyShoppingInfo extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final finalSumTotal = isColor ? sumaTotal * 2 : sumaTotal;
    ...
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          sectionContainerMyShoppingInfoPrice(sumaTotal: finalSumTotal),
