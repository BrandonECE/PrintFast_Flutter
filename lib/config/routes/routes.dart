...
class Routes {
  ...
  static final String payOutstanding = "/payOutstanding";
  ...
  GoRoute _payOutstanding() {
    return GoRoute(
      path: payOutstanding,
      pageBuilder: (context, state) {
        final extra = state.extra as Map<String, dynamic>;
        final outstandingAmount = extra['outstandingCharges'] as double;
        final shoppingPayMethodBloc = extra['shoppingPayMethodBloc'] as Object?;

        Widget child = PayOutstandingView(extra: outstandingAmount);

        if (shoppingPayMethodBloc is ShoppingPayMethodBloc) {
          child = BlocProvider.value(
            value: shoppingPayMethodBloc,
            child: child,
          );
        }
  ...
  GoRoute _myManageCards() {
    return GoRoute(
      ...
      pageBuilder: (context, state) {
        ...
        final extra = state.extra as Map<String, dynamic>;
        final passedBloc = extra['passedBloc'] as Object?;
        final voidCallback = extra['voidCallBack'] as Object?;

        Widget child = MyManageCardsView(
          passedBloc: passedBloc,
  ...
  GoRoute _myAdminSeeUserPaymentMethod() {
    return GoRoute(
      path: adminSeeUserPaymentMethod,
      pageBuilder: (context, state) => CustomTransitionPage(
        key: state.pageKey,
        child: const MyAdminSeeUserPaymentMethodView(),
        transitionsBuilder: (context, animation, secondaryAnimation, child) {
          // CurvedAnimation para suavizar la transición
          final curvedAnimation = CurvedAnimation(
            parent: animation,
  ...
  GoRoute _myAdminOrderHistoryView() {
    return GoRoute(
      ...
      pageBuilder: (context, state) {
        final passedBloc = state.extra as AdminHistoryBloc?;
        Widget child = const MyAdminOrderHistoryView();
  ...
  GoRoute _myAdminMonthOrdersHistorySelectedView() {
    return GoRoute(
      ...
      pageBuilder: (context, state) {
        final passedBloc = state.extra as AdminHistoryBloc?;
        Widget child = const MyAdminMonthOrdersHistorySelectedView();
